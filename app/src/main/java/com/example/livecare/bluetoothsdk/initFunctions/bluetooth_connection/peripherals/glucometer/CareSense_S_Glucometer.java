...
public class CareSense_S_Glucometer {
    ...
    public CareSense_S_Glucometer(BluetoothConnection bluetoothConnection) {
    ...
    public void onConnectedSuccess(BleDevice device, BluetoothGatt gatt) {
        ...
        if (checkPairedDevices(device.getMac())) {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(() ->  startNotifyMeasurement(characteristicMeasurement), 4000);
        }
    }
