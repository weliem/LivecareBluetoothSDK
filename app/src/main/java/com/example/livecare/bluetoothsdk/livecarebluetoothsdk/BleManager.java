package com.example.livecare.bluetoothsdk.livecarebluetoothsdk;
...
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.bluetooth.MultipleBluetoothController;
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.bluetooth.SplitWriter;
...
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.callback.BleScanAndConnectCallback;
...
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.data.BleScanState;
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.exception.OtherException;
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.scan.BleScanRuleConfig;
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.scan.BleScanner;
...
public class BleManager {
    ...
    public void setIsConnecting(boolean flag) {
        isConnecting = flag;
    }
     ...
     * @param callback
     */
    private void notify(BleDevice bleDevice,
                        String uuid_service,
                        String uuid_notify,
     ...
     * @param callback
     */
    private void indicate(BleDevice bleDevice,
                          String uuid_service,
                          String uuid_indicate,
                          boolean useCharacteristicDescriptor,
                          BleIndicateCallback callback) {
     ...
     * @return
     */
    private boolean stopNotify(BleDevice bleDevice,
                               String uuid_service,
                               String uuid_notify,
                               boolean useCharacteristicDescriptor) {
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
     ...
     * @return
     */
    private boolean stopIndicate(BleDevice bleDevice,
                                 String uuid_service,
                                 String uuid_indicate,
                                 boolean useCharacteristicDescriptor) {
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
    ...
    public void disconnect(BleDevice bleDevice) {
        if (multipleBluetoothController != null) {
            multipleBluetoothController.disconnect(bleDevice,1);
        }
    }

    public void disconnectAllDevice() {
        if (multipleBluetoothController != null) {
            multipleBluetoothController.disconnectAllDevice(2);
        }
    }
    ...
    public boolean isScanning(boolean flag) {
        isScanning = flag;
        return isScanning;
    }
