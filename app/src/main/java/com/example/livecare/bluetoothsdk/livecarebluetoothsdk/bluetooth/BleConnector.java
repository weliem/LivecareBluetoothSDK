...
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.data.BleWriteState;
import com.example.livecare.bluetoothsdk.livecarebluetoothsdk.exception.GattException;
    ...
    BleConnector(BleBluetooth bleBluetooth) {
        ...
        this.mHandler = new Handler(Looper.getMainLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                Log.d("BleConnector", "handleMessage: "+msg);
                switch (msg.what) {
